...
---
Delegate to the `ios-runtime-diagnostics` subagent (memgraph mode) to capture an iOS simulator memgraph, identify retention paths, and verify leak fixes for: $ARGUMENTS
