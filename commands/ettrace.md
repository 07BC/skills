...
---
Delegate to the `ios-runtime-profiler` subagent (ETTrace mode) to capture a focused iOS simulator ETTrace profile and identify time-heavy stacks for: $ARGUMENTS
