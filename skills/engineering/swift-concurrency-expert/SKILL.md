...
description: Action-oriented review and fix for Swift Concurrency issues in existing code — not for conceptual questions (use swift-concurrency for those). Use when asked to fix, resolve, or remediate: Swift 6 concurrency compiler errors, data race diagnostics, actor isolation warnings, Sendable conformance gaps, or when migrating completion handlers to async/await in a specific file or feature.
---
